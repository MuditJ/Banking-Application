...
class SavingsAccount extends Account {
    ...
    public synchronized void withdrawAmount(double amount) {
        if (LocalDateTime.now().getMinute() - this.lastWithdrawalDateTime.getMinute() < 5) {
            ...
            if (amount > this.balance) {
                System.out.println("Insufficient balance in your account. Please enter a lower amount");
